...
const modules: DocModule[] = [
  ...
  // CERTIDÕES
  { name: "Certidão de Nascimento", desc: "Certidões de nascimento", credits: 1, available: false, icon: <Heart className="w-5 h-5" />, category: "CERTIDÕES" },
  { name: "Certidão de Casamento", desc: "Certidões de casamento", credits: 1, available: false, icon: <ScrollText className="w-5 h-5" />, category: "CERTIDÕES" },
